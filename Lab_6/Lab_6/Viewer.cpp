...
void Viewer::AddNewObject()
{
	ENUM type = this->SelectType();
...
void Viewer::RemoveOldReference()
{
	ENUM type = this->SelectType();
	int index = this->SelectIndex();
...
void Viewer::AllocateMemoryToExisting()
{
	ENUM type = this->SelectType();
	int index = this->SelectIndex();
...
void Viewer::FreeAllocatedMemory()
{
	ENUM type = this->SelectType();
	int index = this->SelectIndex();
...
void Viewer::InitiazlieAllocated()
{
	ENUM type = this->SelectType();
	int index = this->SelectIndex();
...
Viewer::Viewer(Controller* controller) : controller_(controller)
{
}
